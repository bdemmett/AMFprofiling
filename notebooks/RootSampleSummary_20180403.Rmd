...
```{r}
Samples2017 = read.delim(file = paste(home,'Box/research/BTI/DOE_SorghumMicrobiome/AMF_PacBio/Proposal/Samples_wMetadata_2017_20180403.txt', sep =''), header = TRUE, colClasses = rep("factor"))
head(Samples2017)
...
```
* There are 11 samples that names do not match the metadata file
...
* Everything checks out.  Only two samples are missing and they were from eliminated plots per Allyn's e-mail
